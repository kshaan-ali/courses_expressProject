...
this is the assignmentquestion given by harkirat singh
i have modified some bits in the question and creted the assignment
...
- POST /admin/courses
  ...
  Input: Headers: { 'Authorization': 'Bearer <your-token>' }, Body: { title: 'course title', description: 'course description', price: 100 }
...
- GET /users/purchasedCourses
  ...
  Input: Headers: { 'Authorization': 'Bearer <your-token>' }
  Output: { purchasedCourses: [ { id: 1, title: 'course title', description: 'course description', price: 100] }
